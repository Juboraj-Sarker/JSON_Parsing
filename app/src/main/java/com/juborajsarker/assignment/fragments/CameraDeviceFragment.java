...
public class CameraDeviceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_camera_device, container, false);

        mainStationList = MainActivity.cameraDeviceList;
        init();
    ...
    private void init() {
        ...
        adapter = new CustomAdapter(getContext(), mainStationList, recyclerView, "camera");
